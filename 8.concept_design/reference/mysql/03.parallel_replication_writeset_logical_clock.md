...
- **버전.** `binlog_transaction_dependency_tracking`은 8.0.35부터 deprecated, **8.4·9.x는 변수 제거 → 항상 `WRITESET`**(9.7.0 소스에서 변수 제거 확인). 따라서 "group commit 기준" 자체가 옛 8.0 `COMMIT_ORDER` 한정이다.
